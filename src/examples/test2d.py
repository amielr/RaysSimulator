...
def run_test():
	...
	ax.plot(ntest, my_errors[:,0], color='black',  label='fast_interp_folder, Linear')
	ax.plot(ntest, my_errors[:,1], color='blue',   label='fast_interp_folder, Cubic')
	ax.plot(ntest, my_errors[:,2], color='purple', label='fast_interp_folder, Qunitic')
	ax.plot(ntest, my_errors[:,3], color='red',    label='fast_interp_folder, Septic')
	...
	fig, ax = plt.subplots(1,1)
	ax.plot(ntest, my_setup_time[:,0], color='black',  label='fast_interp_folder, Linear')
	ax.plot(ntest, my_setup_time[:,1], color='blue',   label='fast_interp_folder, Cubic')
	ax.plot(ntest, my_setup_time[:,2], color='purple', label='fast_interp_folder, Qunitic')
	ax.plot(ntest, my_setup_time[:,3], color='red',    label='fast_interp_folder, Septic')
	...
	fig, ax = plt.subplots(1,1)
	ax.plot(ntest, my_eval_time[:,0], color='black',  label='fast_interp_folder, Linear')
	ax.plot(ntest, my_eval_time[:,1], color='blue',   label='fast_interp_folder, Cubic')
	ax.plot(ntest, my_eval_time[:,2], color='purple', label='fast_interp_folder, Qunitic')
	ax.plot(ntest, my_eval_time[:,3], color='red',    label='fast_interp_folder, Septic')
	...
	ax.set_xlabel(r'$n$')
	ax.set_ylabel('Ratio (scipy/fast_interp_folder)')
	ax.set_xscale('log')
	ax.set_yscale('log')
